...
async function fetchTeamMembers(): Promise<DashboardStats["teamMembers"]> {
  try {
...
export default function DashboardPage() {
  ...
  const [teamMembers, setTeamMembers] = React.useState<DashboardStats["teamMembers"]>([]);
  ...
  React.useEffect(() => {
    async function loadData() {
      ...
      const [dashboardStats, members] = await Promise.all([
        fetchDashboardData(),
        showOrgAdmin ? fetchTeamMembers() : Promise.resolve([]),
      ]);
  ...
  const orgStats = stats?.organization || {
  ...
  const recentCutlists = stats?.recentCutlists || [];
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {showOrgAdmin && teamMembers && teamMembers.length > 0 && (
              <Card>
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-lg flex items-center gap-2">
